package com.lab.is.wolfpack.speaker;
...
import com.lab.is.wolfpack.dj.DJActivity;

import java.util.HashMap;
import java.util.Map;

public class SpeakerActivity extends Activity implements ChannelListener,
        ClientDeviceListFragment.SpeakerFragmentListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //This is for service Deepak
        WifiP2pCustomServiceDiscovery.registerService(manager, channel);
        //This is for service Deepak
    ...
    public void disconnect()
    {
        ...
        /*manager.removeGroup(channel, new ActionListener()
        {
            ...
            public void onFailure(int reasonCode)
            {
                Log.e(TAG, "disconnect. Reason is: " + reasonCode);
            }
...
class WifiP2pCustomServiceDiscovery{

    public static void registerService(WifiP2pManager manager, Channel channel){
        //  Create a string map containing information about your service.
        Map record = new HashMap();
        record.put("device",Build.MODEL);
        ...
        manager.addLocalService(channel, serviceInfo, new ActionListener() {
            @Override
            public void onSuccess() {
                Log.d("Speaker","########### Registred successfully #########");
